...
/*****bann5 Citas*****/
$mysql=new MySQL();
$sql5 = $mysql->consulta("SELECT autor,contenido FROM citas_index WHERE diputado  = 1");
		...
		<td id="nivel2_5">
			<div id="nivel2_citas">
				...
				while($row5=$mysql->fetch_array($sql5)){
					...
					echo '<div id="nivel2_citas2">'.$row5[0].'</div>';
				}
				?>
			</div>
		</td>
