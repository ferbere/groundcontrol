...
if(($_SESSION['privilegioss']=='ferbere')||($_SESSION['privilegioss']=='admin')){	
	...
	$sql=$mysql->consulta("UPDATE comprar_directorio SET user='$user' ,name='$name',address='$address',city='$city',state='$state',country='$country',zip='$zip',mail='$mail',phone='$phone',activated='$activated' WHERE id ='$rubro'");
		if(!$sql){
